...
const repo = require('../repository/HomecamRepository');
const RecordWorker = require('./RecordWorker');
...
// 폴백 캡처 길이 (초) — 폴백이 발생했을 때 HLS에서 이 길이만큼 잘라 저장
...
exports.updateStatus = async (record_no, cam_status) =>
  await repo.updateHomecamStatus(record_no, cam_status);

exports.deleteOne  = async (record_no)                => await repo.softDeleteHomecam(record_no);
exports.deleteMany = async (record_nos, isHardDelete) => await repo.deleteMultipleHomecams(record_nos, isHardDelete);

/* =========================
 * 목록 / 검색 / 상세 조회
 * ========================= */
exports.getHomecamList = async (query = {}) => {
...
// 하위 호환
exports.getList = async (page, pageSize, date) => exports.getHomecamList({ page, size: pageSize, date });

// 날짜/상세
exports.searchByDate = async (date) => await repo.searchByDate(date);
exports.getDetail    = async (record_no) => await repo.getHomecamDetail(record_no);
 ...
 * ==================================================================================== */
exports.updateEndMeta = async (record_no, meta = {}) => {
...
// 별칭 (과거 호출명 호환)
exports.endHomecam = exports.updateEndMeta;
